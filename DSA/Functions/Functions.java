...
class Functions {
    public static void main(String[] args) {
        ...
        System.out.println("Before call "+ obj1.myVar1 + "," + obj1.myVar2);
        swapByReference2(obj1);
        System.out.println("After call "+ obj1.myVar1 + "," + obj1.myVar2);
    }

    public static Temp swapByReference2(Temp obj1) {
        int temp = obj1.myVar2;
        obj1.myVar2 = obj1.myVar1;
        obj1.myVar1 = temp;
        return obj1;
    }
